...
const highlights = [
  { label: "Open Source Projects", icon: Code2 },
  { label: "Active GitHub Profile", icon: GitFork },
  { label: "AI & Automation Repositories", icon: Star },
]

const recentActivity = [
  { type: "commit", repo: "ai-cli-assistant", message: "Add context-aware suggestions", time: "Recent work" },
  { type: "commit", repo: "resume-critique", message: "Implement ATS scoring system", time: "Recent work" },
  { type: "commit", repo: "automation-scripts", message: "Add scheduled task runner", time: "Recent work" },
  { type: "commit", repo: "ai-cli-assistant", message: "Improve error handling", time: "Recent work" },
]
    ...
    <section id="github" className="py-24 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">GitHub</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="p-8 rounded-3xl border border-border/50 bg-card/30 backdrop-blur-md">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="text-xl font-bold">@Valentin-PPL</h3>
                <p className="text-muted-foreground text-sm">GitHub Developer Profile</p>
              </div>
            </div>
            ...
            <a
              href="https://github.com/Valentin-PPL"
              target="_blank"
